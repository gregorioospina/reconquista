	...
	return open ? (
		<div
			...
			<div
				...
				className={`min-h-30% max-h-90% duration-1200 relative z-30 w-[95%] max-w-[500px] grid-cols-1 grid-rows-[15%_85%] rounded-xl bg-white p-4 transition-[max-height] md:max-h-95% md:w-1/3 md:min-w-[500px] md:p-6 ${containerClassName} `}
