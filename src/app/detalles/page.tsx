	...
	return (
		<div
			...
			<main className="flex flex-col gap-8 row-start-2 justify-start px-[25svw]">
				...
				{/* todo */}
				<div className="h-[60svh] relative w-full mt-[-120px] mb-[-40px]">
				...
				<div className="flex flex-col">
					...
					<p className="font-title text-lg md:text-4xl">Drinks y Picoteo</p>
					<p className="font-body font-semibold text-sm md:text-base mt-2">URBAN PLAZA. Calle 90 #11-13 Bogotá.</p>
					<p className="font-body md:text-base md:leading-5 leading-3 text-sm  text-justify">
				...
				<div className="mt-1 flex flex-col gap-y-3 items-start">
					<button className="underline font-highlights font-light">confirmar</button>
					<button className="underline font-highlights font-light">¿cómo llegar?</button>
				...
				<div className="flex flex-col">
					...
					<p className="font-title text-lg md:text-4xl">Ceremonia y Celebración</p>
